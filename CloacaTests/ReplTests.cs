...
namespace CloacaTests
{
    ...
    public class ReplTests : RunCodeTest
    {
        ...
        public async Task Dir()
        {
            ...
            Assert.That(consoleOut, Is.EqualTo("[__add__, __and__, __delattr__, __eq__, __floordiv__, __ge__, __getattr__, __getattribute__, __gt__, __init__, __le__, __lshift__, __lt__, __ltgt__, __mod__, __mul__, __ne__, __or__, __pow__, __repr__, __rshift__, __setattr__, __str__, __sub__, __truediv__, __xor__]\r\n"));
        }
