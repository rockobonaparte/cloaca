            ...
            while (cursor < code.Bytes.Length)
            {
                ...
                switch ((ByteCodes)code[cursor])
                {
                    case ByteCodes.BINARY_ADD:
                        disassembly += disassembleLine(null, cursor - 1, "BINARY_ADD", null, null);
                        cursor += 1;
                        break;
                    case ByteCodes.BINARY_SUBTRACT:
                        disassembly += disassembleLine(null, cursor - 1, "BINARY_SUB", null, null);
                        cursor += 1;
                        break;
                    case ByteCodes.BINARY_MULTIPLY:
                        disassembly += disassembleLine(null, cursor - 1, "BINARY_MUL", null, null);
                        cursor += 1;
                        break;
                    case ByteCodes.BINARY_DIVIDE:
                        disassembly += disassembleLine(null, cursor - 1, "BINARY_DIV", null, null);
                        cursor += 1;
                        break;
                    ...
                    case ByteCodes.LOAD_NAME:
                        cursor += 1;
                        disassembly += disassembleLine(null, cursor - 1, "LOAD_NAME", code.GetUShort(cursor), string.Format("({0})", codeObject.VarNames[code.GetUShort(cursor)]));
                        cursor += 2;
                        break;
                    ...
                    case ByteCodes.POP_BLOCK:
                        ...
                        disassembly += disassembleLine(null, cursor - 1, "POP_BLOCK", null, null);
                        cursor += 1;
                        break;
                    ...
                    case ByteCodes.WAIT:
                        // TODO: Block targets should have a >> cursor next to them.
                        disassembly += disassembleLine(null, cursor - 1, "WAIT", null, null);
                        cursor += 1;
                        break;
                    ...
                    case ByteCodes.RETURN_VALUE:
                        disassembly += disassembleLine(null, cursor - 1, "RETURN_VALUE", null, null);
                        cursor += 1;
                        break;
                    ...
                    case ByteCodes.BUILD_LIST:
                        {
                            ...
                            disassembly += disassembleLine(null, cursor - 1, "BUILD_LIST", list_size, null);
                            cursor += 2;
                        }
                        break;
                    case ByteCodes.BINARY_SUBSCR:
                        disassembly += disassembleLine(null, cursor - 1, "BINARY_SUBSCR", null, null);
                        cursor += 1;
                        break;
